        ...
        <tbody>
          <tr
            ...
            <td>
              <router-link
                v-if="item"
                :to="{name: 'SkillShow', params: { id: item['@id'] }}">
                {{ item['@id'] }}
              </router-link>
            </td>
            <td>
            ...
            <td>
              <router-link :to="{name: 'SkillUpdate', params: { id: item['@id'] }}">
                <span
                  class="fa fa-pencil"
                  aria-hidden="true" />
...
export default {
  computed: mapGetters({
    deletedItem: 'skill/del/deleted',
    error: 'skill/list/error',
    items: 'skill/list/items',
    isLoading: 'skill/list/isLoading',
    view: 'skill/list/view'
  }),
